...
public class SkipListDriver {
	public static void main(String[] args) throws FileNotFoundException {
		...
		final long inf1 = Long.MIN_VALUE;// storing the left sentinel ie minus
											// infinity
		final long inf2 = Long.MAX_VALUE;// storing the right sentinel ie plus
											// infinity

		// 7 here is the no of elements required of ideal skipLists

		SkipListImpl<Long> skipList = new SkipListImpl<Long>(7, inf1, inf2);
